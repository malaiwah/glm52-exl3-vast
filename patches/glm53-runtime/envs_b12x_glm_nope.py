...
if TYPE_CHECKING:
    ...
    VLLM_B12X_GLM_NOPE_NVFP4: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Opt in to the GLM NoPE NVFP4 specialization shipped by dedicated B12X
    # device builds. Generic images remain fail closed.
    "VLLM_B12X_GLM_NOPE_NVFP4": lambda: bool(
        int(os.getenv("VLLM_B12X_GLM_NOPE_NVFP4", "0"))
    ),
