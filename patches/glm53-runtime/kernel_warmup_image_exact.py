...
from vllm.model_executor.warmup.glm5_kpool_warmup import (
    warmup_glm5_kpool_prefill,
)
...
def runtime_kernel_warmup(worker: "Worker") -> None:
    ...
    warmed_kpool_prefill = warmup_glm5_kpool_prefill(worker)
    if warmed_kpool_prefill:
        logger.info(
            "Warmed up %d GLM5 K-pool prefill variants.",
            warmed_kpool_prefill,
        )
