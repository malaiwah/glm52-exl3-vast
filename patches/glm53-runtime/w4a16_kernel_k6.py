...
def compile_w4a16_fused_moe(
    *,
    ...
    if (
        ...
        # K6's wider packed payload plus the route-128 exchange tile exceeds
        # the SM120 shared-memory ceiling. Stream each logical route block as
        # two 64-row compute blocks with the qualified two-stage schedule.
        fc1_compute_block_size = 64
        fc2_compute_block_size = 64
        fc1_pipeline_stages = 2
        fc2_pipeline_stages = 2
