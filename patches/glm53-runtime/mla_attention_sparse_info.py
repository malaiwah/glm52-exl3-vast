    ...
    def __init__(
        ...
        **extra_impl_args,
        ...
        if self.impl.is_sparse and not (
            ...
            logger.info_once(
                "Sparse MLA is using its native top-k MQA prefill path; "
                "dense-MHA prefill is unavailable for this backend."
            )
