...
| GPU utilization 0.955 | 0.9 | r9 dynamic-token safety point with graph profiling | exposed 532,224 KV tokens, preserved the 513,536 request limit, and retained about 1 GiB/GPU late in the maximum-context gate | 1.04× maximum-request concurrency; rentals and driver changes still require a cold boot | retain flagship |
