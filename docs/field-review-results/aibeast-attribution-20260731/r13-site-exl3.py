...
class Exl3MoEMethod(FusedMoEMethodBase):
            ...
            for suffix in ("suh", "svh", "trellis", "mcg", "mul1"):
                layer.register_parameter(
                    ...
                    Exl3MoEParameter(
                        ...
                        shard_ids=shard_ids,
                        preallocate=rank_sliced and suffix in ({"suh", "svh"} if getattr(self.quant_config, "mixed_k_values", None) else {"suh", "svh", "trellis"}),
                    ),
                )
    ...
    def _apply_rank_sliced(
        ...
        if getattr(layer, "exl3_mixk", None) is not None:
...
# === EXL3-MIXK-PATCH v1 ===
# === EXL3-MIXK-PATCH v3 (shared runtime, aliased arenas) ===
# === EXL3-MIXK-PATCH v4 (r13 consolidated fused-MoE API) ===
# === EXL3-MIXK-PATCH v5 (backend Trellis minimum) ===
