...
RUN pip install --no-cache-dir "huggingface_hub[hf_transfer]" && apt-get update -qq && apt-get install -y -qq nvtop htop curl openssh-server && rm -rf /var/lib/apt/lists/* \
